    ...
    <div className="flex flex-col gap-8">
      <div className="relative overflow-hidden rounded-xl shadow-lg">
        ...
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 flex flex-col items-start justify-center bg-gradient-to-t from-black/80 to-transparent p-4 py-8 sm:p-8 md:p-12">
          <div className="max-w-2xl">
            <h1 className="font-headline text-xl text-white sm:text-3xl md:text-5xl">
                {t.heroTitle}
            </h1>
