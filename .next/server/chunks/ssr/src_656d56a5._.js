...
"[project]/src/app/data:8108c4 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$8108c4__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/data:8108c4 [app-ssr] (ecmascript) <text/javascript>");
...
const formSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["z"].object({
    plantImage: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["z"].any().refine((files)=>files?.length == 1, 'Image is required.').refine((files)=>files?.[0]?.size <= 5000000, `Max file size is 5MB.`).refine((files)=>[
            'image/jpeg',
            'image/png'
...
function PestDetectionClient() {
    ...
    const onSubmit = async (data)=>{
        ...
        reader.onload = async ()=>{
            ...
            try {
                const detectionResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$8108c4__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["handlePestDetection"])({
...
//# sourceMappingURL=src_656d56a5._.js.map